...
const App = () => {
  ...
  const handleLogout = () => {
    ...
    // 2. Navegación FORZADA a la raíz (Home) usando Hash
    // Esto asegura que el navegador vaya a #/ antes de cualquier recarga
    window.location.hash = "/"; 
    
    // 3. Recargar para limpiar cualquier estado en memoria
